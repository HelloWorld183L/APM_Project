...
results
```
From these results, it would appear that the glmnet logistic regression model has the greatest performance as it has the greatest F1 score and AUC. It is also relatively quick to train which can reduce costs if deployed in a large-scale system.
