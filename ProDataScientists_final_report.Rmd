...
```{r message=FALSE}
plot_roc_curves(svm_wow_poly_pred_y, mlp_wow_tuned_pred_y, glm_wow_tuned_pred_y, c("SVM Poly", "MLP Tuned", "GLMNET"), wow_test_balanced)
```
...
results = create_table(prediction_list, time_to_train, lol_test_balanced)
results
```
