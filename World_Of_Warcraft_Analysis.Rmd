...
```{r}
train_control_grid = caret::trainControl(method = "repeatedcv", number = 5, repeats = 3)
small_train_control_grid = caret::trainControl(method = "repeatedcv", number = 5, repeats = 1)
...
svm_linear_tuned = caret::train(is_bullying~ ., data = train_balanced, method = "svmLinear", trControl = random_train_control_grid, tuneLength=5)
...
svm_model_poly = caret::train(is_bullying~ ., data = train_balanced, method = "svmPoly", trControl = random_train_control_grid, tuneLength=5)
...
svm_model_rbf = caret::train(is_bullying~ ., data = train_balanced, method = "svmRadial", trControl = random_train_control_grid, tuneLength=5)
