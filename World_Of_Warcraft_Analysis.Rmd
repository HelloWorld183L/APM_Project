...
```{r}
caret::confusionMatrix(data=svm_pred_y, reference=test_balanced$is_bullying, mode="everything")
```
...
```{r}
caret::confusionMatrix(data=mlp_pred_y, reference=test_balanced$is_bullying, mode="everything")
```
...
```{r}
caret::confusionMatrix(data=rf_pred_y, reference=factor(test_balanced$is_bullying), mode="everything")
```
...
rf_confusion_matrix <- caret::confusionMatrix(data=rf_pred_y, reference=factor(test_balanced$is_bullying), mode="everything")
```
